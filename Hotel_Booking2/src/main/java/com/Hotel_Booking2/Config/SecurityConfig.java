...
import com.Hotel_Booking2.security.CustomUserDetailsService;
import com.Hotel_Booking2.security.JwtAuthenticationEntryPoint;
import com.Hotel_Booking2.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/auth/**").permitAll()//security
